        ...
        return (
            <div className="container">
                <div className="row breadcrumbs">
                    <div className="col-1"><a href="#"><i className="fas fa-arrow-left "></i></a></div>
                    <div className="col-10"><h4>manchesterunited</h4></div>
                    <div className="col-1"><a href="#"><i className="fas fa-ellipsis-v"></i></a></div>
                </div>
                    ...
                    <div className="col-12">
                        <ul className="nav nav-tabs" id="myTab" role="tablist">
                            <li className="nav-item col-4" >
                                <a className="nav-link text-center active" id="images-tab" data-toggle="tab" href="#images" role="tab"
                ...
                <div className="tab-content" id="myTabContent">
                    <div className="tab-pane fade show active" id="images" role="tabpanel" aria-labelledby="images-tab">
                        <div className="row images">
                            <div className="col-4"><a href="#"><img src="images/banner-leeds-600x600.jpg" alt="" className="rounded-0 float-left img-fluid"/></a></div>
                            <div className="col-4"><a href="#"><img src="images/banner-perth-glory-600x600.jpg" alt="" className="rounded-0 float-left img-fluid"/></a></div>
                            <div className="col-4"><a href="#"><img src="images/home-pre-sale-600x600.jpg" alt="" className="rounded-0 float-left img-fluid"/></a></div>
                        </div>
                    </div>
